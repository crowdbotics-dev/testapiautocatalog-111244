...
## Project Structure
    ...
    ├── testapiautocatalog_111244  # Django project configurations
...
1. Clone this repo and `cd testapiautocatalog_111244`
...
2. Clone this repo and `cd testapiautocatalog_111244`
